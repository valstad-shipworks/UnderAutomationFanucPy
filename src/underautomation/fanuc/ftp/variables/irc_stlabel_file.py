...
from UnderAutomation.Fanuc.Ftp.Variables import IrcStlabelFile as irc_stlabel_file

class IrcStlabelFile(GenericVariableFile):
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = irc_stlabel_file()
		else:
