...
from UnderAutomation.Fanuc.Ftp.Variables import Refpos11VariableType as refpos11_variable_type

class Refpos11VariableType(GenericVariableType):
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = refpos11_variable_type()
		else:
