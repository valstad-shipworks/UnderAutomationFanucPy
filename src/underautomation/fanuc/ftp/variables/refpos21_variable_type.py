...
from UnderAutomation.Fanuc.Ftp.Variables import Refpos21VariableType as refpos21_variable_type

class Refpos21VariableType(GenericVariableType):
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = refpos21_variable_type()
		else:
