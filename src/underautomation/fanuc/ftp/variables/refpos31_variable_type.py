...
from UnderAutomation.Fanuc.Ftp.Variables import Refpos31VariableType as refpos31_variable_type

class Refpos31VariableType(GenericVariableType):
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = refpos31_variable_type()
		else:
