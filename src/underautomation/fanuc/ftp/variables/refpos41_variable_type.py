...
from UnderAutomation.Fanuc.Ftp.Variables import Refpos41VariableType as refpos41_variable_type

class Refpos41VariableType(GenericVariableType):
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = refpos41_variable_type()
		else:
