...
from UnderAutomation.Fanuc.Ftp.Variables import Refpos51VariableType as refpos51_variable_type

class Refpos51VariableType(GenericVariableType):
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = refpos51_variable_type()
		else:
