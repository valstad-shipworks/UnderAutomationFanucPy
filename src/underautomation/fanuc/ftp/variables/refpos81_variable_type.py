...
from UnderAutomation.Fanuc.Ftp.Variables import Refpos81VariableType as refpos81_variable_type

class Refpos81VariableType(GenericVariableType):
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = refpos81_variable_type()
		else:
